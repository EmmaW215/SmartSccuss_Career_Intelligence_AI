...
class StartInterviewRequest(BaseModel):
    ...
    focus_areas: Optional[list] = None  # e.g., ["python", "system_design"]
...
async def start_technical_interview(
    ...
    questions = get_questions_for_type("technical")
...
async def submit_response(
    ...
    next_question = next_q.get("question", "Tell me more about your technical approach.")
