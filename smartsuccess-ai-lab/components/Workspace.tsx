...
import { Challenge, FileNode, Message } from '../types';
...
export const Workspace: React.FC<WorkspaceProps> = ({ challenge, onExit, onSubmit }) => {
  const [activeFile, setActiveFile] = useState<FileNode>(challenge.initialFiles[0]);
  const [files, setFiles] = useState<FileNode[]>(challenge.initialFiles);
