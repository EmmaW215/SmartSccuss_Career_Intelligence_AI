"""
In-Memory Session Store (Phase 2 - Optional)
Lightweight session management for Phase 2 features (customize, dashboard)

Note: This is separate from existing interview session management
Only used for Phase 2 features when enabled
"""
