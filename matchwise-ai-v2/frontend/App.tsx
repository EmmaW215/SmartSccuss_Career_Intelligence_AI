...
// Constants — uses Vite env vars (import.meta.env.VITE_*)
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || 'https://resume-matcher-backend-rrrw.onrender.com';
const STRIPE_KEY = import.meta.env.VITE_STRIPE_KEY || 'pk_test_51RnB7HE6OOEHr6ZoCxyyExample';
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!user) {
        ...
        // Optimistic update - backend handles usage counting, we just refresh status
